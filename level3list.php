...
$sql = "SELECT e.event_id,e.eventtitle,e.is_verified,e.verified_timestamp,e.is_approved,u.firstname, u.lastname,r.regionname,e.town FROM events as e inner join region as r on r.region_id= e.region inner join users as u on u.userid = e.creator WHERE is_verified='$constant'";
