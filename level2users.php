...
$sql = "select u.userid as userid, u.firstname as fname, u.lastname as lname, u.email as email, u.status as status, r.regionname as region from users as u inner join region as r on r.region_id = u.region where (u.level < 2 and u.region = '$id')";
