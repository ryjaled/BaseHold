...
$sql = "select r.report_id, r.eventtitle, r.date_organized, u.regionname as region, r.is_verified, r.is_approved from reports as r inner join region as u on u.region_id = r.region where r.reporter = '$id'";
...
while( $row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$buttonshow = "<a onclick='level1viewer({$row['report_id']})' class='btn btn-twitter btn-just-icon '><i class='material-icons'>assignment</i></a>";
