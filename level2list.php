...
if( $row['is_approved'] == "0"){
  ...
  if( $row['is_approved'] == "2"){
    ...
    if( ($row['is_verified'] == "0") && ($row['is_approved'] == "0") )
    {
      ...
      $buttonshow = "<div class='dropdown'><button href='#' class='btn-simple btn-primary dropdown-toggle' data-toggle='dropdown' aria-expanded='true'><b class='caret'></b></button><ul class='dropdown-menu'><li><a onclick='verifyEventToggle(".$queryID.",\"".$queryVerification."\")' href='#'>Verify</a></li><li><a onclick='level2View({$row['event_id']})' href='#'>View Details</a></li><li><a onclick='' href='#' style='color: red;'>Reject</a></li></ul></div>";
    }
